...
# define TNAME(id) id##_##SSCANF

const CHAR * TNAME(str_double)[] =
{
...
struct test TNAME(double_tests)[] =
{
  { L("-1"), L("%1g"), 0 },
  { L("-.1"), L("%2g"), 0 },
  { L("-inf"), L("%3g"), 0 },
